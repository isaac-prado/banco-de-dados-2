from sqlalchemy import (
    Column, String, Integer, Enum as SQLAlchemyEnum,
...
class Produto(Base):
    ...
    nutriscore = Column(SQLAlchemyEnum(TipoNutriEcoScoreDB, name='tipo_nutri_eco_score'))
    ecoscore = Column(SQLAlchemyEnum(TipoNutriEcoScoreDB, name='tipo_nutri_eco_score'))
    novascore = Column(SQLAlchemyEnum(TipoNovaScoreDB,  name='tipo_nova_score', values_callable=lambda x: [e.value for e in x]))
